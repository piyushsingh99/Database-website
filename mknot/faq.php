...
<div class="mid">
   ...
   data-aos-duration="2000">
    <h2>Welcome to Our <span>Myknot</span> FAQ PART</h2>
...
<h4>1. List of domains in which we provide our services.</h4>
<ul class="pl-5">
<li> school </li>
<li>   colleges </li>
<li>  job seekers </li>
...
<h4>2. what we do?</h4>
<p class="pl-3"> Myknot database is well oriented in proffering solution to their customers by providing secure space and domain to their business.</p>
<h4>3. What is the price for availing a database?</h4>
<p  class="pl-3">To know the price , login on the myknot database website and on the home page you will see the list of price according to the services offered.</p>

<h4>4. How to download?</h4>

<p class="pl-3">it is simple, easy and within few clicks , all that required is to select the exact list needed located on the left column, verify and download the right way.</p>

<h4>5. Frequency of updation of database.</h4>
<p class="pl-3">we update our database regularly after 30 days.</p>
</div>
...
<footer>
    ...
    <div class="con">
        ...
        <div>
            <ul>
                <li class="p-2"> <a href="main.php">HOME</a></li>
                <li class="p-2"> <a href="main.php">ABOUT</a></li>
                <li class="p-2"> <a href="main.php">SERVICES</a></li>
                <br>
